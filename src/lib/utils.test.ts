...
describe("formatOrderId", () => {
  it("formats a UUID into a short #TRN id", () => {
    expect(formatOrderId("a1b2c3d4-e5f6-7890-abcd-ef1234567890")).toBe(
      "#TRN-A1B2C3"
    )
  })

  it("strips non-hex noise and uppercases the first 6 characters", () => {
    expect(formatOrderId("zz9xyz-0000-0000-0000-000000000000")).toBe(
      "#TRN-ZZ9XYZ"
    )
  })
...
describe("formatOrderTitle", () => {
  it("prefixes the formatted id with 'Order'", () => {
    expect(formatOrderTitle("a1b2c3d4-e5f6-7890-abcd-ef1234567890")).toBe(
      "Order #TRN-A1B2C3"
    )
  })
})
