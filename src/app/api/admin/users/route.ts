...
/**
 * Resolve the effective permission flags for a role. Admins always get full
...
function resolvePermissions(
  ...
  return {
    ...
    canManageCategories: requested?.canManageCategories ?? false,
    canManageProducts: requested?.canManageProducts ?? false,
  }
}
