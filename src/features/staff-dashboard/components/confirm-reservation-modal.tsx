...
export function ConfirmReservationModal({ isOpen, onClose, onConfirm, reservation, loading }: ConfirmReservationModalProps) {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-card w-full max-w-sm rounded-xl shadow-2xl overflow-hidden border border-border animate-in zoom-in duration-200">
        <div className="px-5 py-4 border-b border-border flex justify-between items-center bg-muted/20">
          <h2 className="text-sm font-bold text-foreground">Confirm Reservation</h2>
        ...
        <div className="p-5 space-y-4">
          <div className="p-3 bg-green-50 rounded-lg border border-green-200 text-center">
            ...
            <p className="text-sm font-bold text-green-800">Confirm this reservation?</p>
          </div>
        ...
        <div className="px-5 py-4 border-t border-border bg-muted/20 flex justify-end gap-2">
          ...
          <button
            onClick={onConfirm}
            disabled={loading}
            className="px-4 py-2 bg-green-600 text-white rounded-lg text-xs font-bold hover:bg-green-700 disabled:opacity-40 disabled:pointer-events-none transition-colors shadow-xs"
          >
